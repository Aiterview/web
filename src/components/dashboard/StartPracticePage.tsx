  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="bg-white rounded-xl shadow-sm overflow-hidden flex flex-col items-center justify-center min-h-[500px] h-auto p-6 md:p-12">
        ...
        <p className='text-gray-600 text-sm font-normal mb-8 text-center'>Click the button below to start your training and take the first step toward landing your dream job!</p>
